...
# Importamos nuestros módulos creados previamente
...
def plot_training_history(history_cnn, history_vgg, epochs):
    """
    Función para graficar y comparar el Accuracy y Loss de ambos modelos.
    Se generarán dos gráficas (una de Accuracy y otra de Loss) que se guardarán como imagen.
    """
...
def main():
    ...
    # Puedes modificar el batch_size si tu computadora se queda sin memoria
    train_gen, val_gen = get_data_generators(current_dir, target_size=(150, 150), batch_size=32)
    
    EPOCHS = 15 # Puedes aumentar este número a 20 o 30 para mejorar resultados

    # 2. Entrenar Modelo 1: CNN Básica
    ...
    # 3. Entrenar Modelo 2: Transfer Learning (VGG16)
    ...
    # 4. Generar las gráficas comparativas (Entrega del desafío)
    print("\n=== PASO 4: Generando Gráficas de Resultados ===")
    plot_training_history(history_cnn, history_vgg, EPOCHS)

if __name__ == '__main__':
    # Para evitar errores con librerías si faltan
    try:
        main()
